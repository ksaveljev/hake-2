...
initialFastRenderAPIGlobals =
  FastRenderAPIGlobals { _frGLDepthMin           = 0
                       ...
                       , _frModKnown             = unsafePerformIO $ V.replicateM maxModKnown (newIORef newModelT)
                       , _frModNumKnown          = 0
                       , _frLoadModel            = unsafePerformIO $ newIORef newModelT
                       , _frCurrentModel         = Nothing
                       , _frModInline            = unsafePerformIO $ V.replicateM maxModKnown (newIORef newModelT)
                       , _frModNoVis             = ""
                       ...
                       , _frCBrushPolys          = 0
                       , _frCAliasPolys          = 0
                       , _frFrustum              = unsafePerformIO $ V.replicateM 4 (newIORef newCPlaneT)
