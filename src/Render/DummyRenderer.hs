...
dummyRefExportT kbd renderAPI =
  RefExportT { _reInit                = dummyInit renderAPI
...
dummyInit renderAPI vidXPos vidYPos =
  ...
  where postInit False = return False
...
dummyRenderAPI =
    RenderAPI { _rInit              = \_ _ _ -> return True
...
dummyGLDriver =
  GLDriver { _gldInit            = \_ _ -> return True
