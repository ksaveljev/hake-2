...
proceedLoadClientInfo :: Traversal' QuakeState ClientInfoT -> Renderer -> Float -> B.ByteString -> B.ByteString -> Quake ()
proceedLoadClientInfo clientInfo renderer noSkins name str = do
