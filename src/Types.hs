...
import           Control.Monad.State.Strict   (State, StateT, MonadState, MonadIO)
import           Control.Monad.State.Strict   (lift, get, put, liftIO)
...
type Quake = StateT QuakeState IO
