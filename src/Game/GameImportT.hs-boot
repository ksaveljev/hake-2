...
giCprintf            :: Functor f => ((Maybe EdictRef -> Int -> B.ByteString -> Quake ()) -> f (Maybe EdictRef -> Int -> B.ByteString -> Quake ())) -> GameImportT -> f GameImportT
giCenterPrintf       :: Functor f => ((EdictRef -> B.ByteString -> Quake ()) -> f (EdictRef -> B.ByteString -> Quake ())) -> GameImportT -> f GameImportT
giSound              :: Functor f => ((Maybe EdictRef -> Int -> Int -> Float -> Float -> Float -> Quake ()) -> f (Maybe EdictRef -> Int -> Int -> Float -> Float -> Float -> Quake ())) -> GameImportT -> f GameImportT
giPositionedSound    :: Functor f => ((Maybe (V3 Float) -> EdictRef -> Int -> Int -> Float -> Float -> Float -> Quake ()) -> f (Maybe (V3 Float) -> EdictRef -> Int -> Int -> Float -> Float -> Float -> Quake ())) -> GameImportT -> f GameImportT
...
giSetModel           :: Functor f => ((EdictRef -> Maybe B.ByteString -> Quake ()) -> f (EdictRef -> Maybe B.ByteString -> Quake ())) -> GameImportT -> f GameImportT
giTrace              :: Functor f => ((V3 Float -> Maybe (V3 Float) -> Maybe (V3 Float) -> V3 Float -> Maybe EdictRef -> Int -> Quake TraceT) -> f (V3 Float -> Maybe (V3 Float) -> Maybe (V3 Float) -> V3 Float -> Maybe EdictRef -> Int -> Quake TraceT)) -> GameImportT -> f GameImportT
...
giLinkEntity         :: Functor f => ((EdictRef -> Quake ()) -> f (EdictRef -> Quake ())) -> GameImportT -> f GameImportT
giUnlinkEntity       :: Functor f => ((EdictRef -> Quake ()) -> f (EdictRef -> Quake ())) -> GameImportT -> f GameImportT
giBoxEdicts          :: Functor f => ((V3 Float -> V3 Float -> Lens' QuakeState (V.Vector EdictRef) -> Int -> Int -> Quake Int) -> f (V3 Float -> V3 Float -> Lens' QuakeState (V.Vector EdictRef) -> Int -> Int -> Quake Int)) -> GameImportT -> f GameImportT
...
giUnicast            :: Functor f => ((EdictRef -> Bool -> Quake ()) -> f (EdictRef -> Bool -> Quake ())) -> GameImportT -> f GameImportT
