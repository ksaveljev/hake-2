...
giTrace              :: Functor f => ((V3 Float -> V3 Float -> V3 Float -> V3 Float -> EdictReference -> Int -> Quake TraceT) -> f (V3 Float -> V3 Float -> V3 Float -> V3 Float -> EdictReference -> Int -> Quake TraceT)) -> GameImportT -> f GameImportT
